...
function Footer() {
  ...
  return (
    <footer className="bg-[#DAD887] text-[#36656B] pt-24 pb-12 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-6 gap-12 pb-16 border-b border-gray-800">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold">AuraFarm</h3>
            </div>
            <p className="text-black mb-8 leading-relaxed max-w-sm">Empowering Indian farmers with technology, market access, and fair prices for a sustainable agricultural future.</p>
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a key={social.name} href={social.url} className="w-12 h-12 bg-[#DAD887] hover:bg-green-600 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 p-2.5">
            ...
            <div key={index}>
              ...
              <ul className="space-y-4">
                {column.links.map((link, linkIndex) => (
                  <li key={linkIndex}>
                    <a href="#" className="text-black hover:text-white transition-colors">{link}</a>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="pt-10 flex flex-col items-center gap-6">
          ...
          <p className="text-black text-center" > &copy; 2026 AuraFarm. All rights reserved. Made with love for Indian Farmers.</p>
