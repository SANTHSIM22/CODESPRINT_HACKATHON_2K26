...
function Header() {
  ...
  const navItems = [
    ...
    { key: 'benefits', label: t('header.benefits') },
    { key: 'how-it-works', label: t('header.howItWorks') },
    { key: 'testimonial', label: t('header.testimonial') },
  ];
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group cursor-pointer">
            ...
            <h1 className="text-2xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">AuraFarm</h1>
          </Link>
